...
public class CodeGenerationController extends BaseController {    
    ...
    public void usingFileAsStringAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5247028226045980612L;
            {
                    put( "name", name );
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4738018238018219662L;
            {
        ...
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4919111415092219322L;
            {
                    put( "body", body );
            }
        };
    ...
    public void usingUrlAsStringAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5721327991426516714L;
            {
                    put( "template", (template != null) ? template.value() : null );
                    put( "format", (format != null) ? format.value() : null );
                    put( "name", name );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4746419401814817047L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingFileAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5348214735579884180L;
            {
                    put( "name", name );
                    put( "format", (format != null) ? format.value() : null );
                    put( "template", (template != null) ? template.value() : null );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5156571747919672267L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
        ...
        //load all fields for the outgoing API request
        Map<String, Object> _parameters = new HashMap<String, Object>() {
            private static final long serialVersionUID = 4625102097615971207L;
            {
                    put( "body", body );
            }
        };
    ...
    public void usingUrlAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5174390882269753388L;
            {
                    put( "template", (template != null) ? template.value() : null );
                    put( "format", (format != null) ? format.value() : null );
                    put( "name", name );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5497341448035735942L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingApikeyAsBinaryAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5430799829525005011L;
            {
                    put( "apikey", apikey );
                    put( "template", (template != null) ? template.value() : null );
                    put( "dl", (dl != null) ? dl : 1 );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5472315211367477298L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
    ...
    public void usingApikeyAsStringAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4741272888408110196L;
            {
                    put( "apikey", apikey );
                    put( "template", (template != null) ? template.value() : null );
                    put( "dl", (dl != null) ? dl : 0 );
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4785491983043130257L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
            }
        };
